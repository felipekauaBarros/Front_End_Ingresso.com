...
export class FormIngressoComponent {
  ...
  private realizarincluzao() {
    ...
    this.ingressoService.ingressoControllerIncluir({body: this.formGroup.value})
      .subscribe(retorno => {
  ...
  private prepararEdicao() {
    ...
    if(paramid) {
      ...
      this.ingressoService.ingressoControllerObterPorId({id: id})
        .subscribe(retorno =>
      {
  ...
  private alteracao() {
    console.log("Dados:", this.formGroup.value);
    this.ingressoService.ingressoControllerAlterar({id: this.id as number, body: this.formGroup.value})
      .subscribe(retorno => {
        console.log("Retorno:", retorno);
